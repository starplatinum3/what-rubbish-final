...
//————————————————
//        版权声明：本文为CSDN博主「wd0032」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
//        原文链接：https://blog.csdn.net/wd0032/article/details/79680215
...
public class DateUtil {
    ...
    public static final String ymdhmsZh = "yyyy年MM月dd日 HH时mm分ss秒";
    public static final String ymdZh = "yyyy年MM月dd日";
    //public static final String ymdhmZh = "yyyy年MM月dd日";
...
//    	System.out.println(min);
    ...
    static void sqlDt() {
        Timestamp timestamp = TimeUtil.nowSqlTime();
        Date date = TimeUtil.sqlStampToDate(timestamp);
    }

    public static void main(String[] args) {
        String dateStr = "2021/2/4 10:44:32";
        String dateStr2 = "2021/2/8 10:44:22";
        Date date = stringToDate(dateStr, "yyyy/MM/dd hh:mm:ss");
        Date date2 = stringToDate(dateStr2, "yyyy/MM/dd hh:mm:ss");
