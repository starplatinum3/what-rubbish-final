//package com.example.whatrubbish.tabLayout;
...
//import com.example.whatrubbish.achievement.AchievementFragment;
...
//
//        tabLayout.addTab(tabLayout.newTab().setText("首页").setIcon(R.drawable.ic_dashboard_black_24dp));
//        tabLayout.addTab(tabLayout.newTab().setText("消息").setIcon(R.drawable.ic_dashboard_black_24dp));
//        tabLayout.addTab(tabLayout.newTab().setText("工具").setIcon(R.drawable.ic_dashboard_black_24dp));
//        tabLayout.addTab(tabLayout.newTab().setText("提醒").setIcon(R.drawable.ic_dashboard_black_24dp));
//        tabLayout.addTab(tabLayout.newTab().setText("我").setIcon(R.drawable.ic_dashboard_black_24dp));
//
//
////        stringList.add("勋章");
////        stringList.add("好友");
