...
//    TextView weidunum;
    ...
    public void liaotian(View view){
        ...
        Intent intent = new Intent( SelectGameActivity.this,com.hrl.chaui.activity.SplashActivity.class);
    ...
    public void tuichu(View view){
        ...
        //  flag=1;
        Intent intent = new Intent( SelectGameActivity.this,com.example.smlj.login.class);
        startActivity(intent);
