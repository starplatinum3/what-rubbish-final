...
public class NoBottomNavActivity extends AppCompatActivity {
...
//    TextView weidunum;
    ...
    public void liaotian(View view){
        ...
        Intent intent = new Intent( NoBottomNavActivity.this,com.hrl.chaui.activity.SplashActivity.class);
    ...
    public void tuichu(View view){
        ...
        //  flag=1;
        Intent intent = new Intent( NoBottomNavActivity.this,com.example.smlj.login.class);
        startActivity(intent);
...
//        binding = ActivityTestBinding.inflate(getLayoutInflater());
        binding = ActivityNoBottomNavBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        //holder

        getSupportFragmentManager().beginTransaction().
                //replace(R.id.holder,new TestHolderFragment()).addToBackStack(null).commit();
                replace(R.id.holder,new SelectGameFragment()).addToBackStack(null).commit();
