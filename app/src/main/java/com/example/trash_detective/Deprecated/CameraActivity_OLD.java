...
//
//public class CameraActivity_OLD extends AppCompatActivity implements View.OnTouchListener {
//
...
//        act_button = findViewById(R.id.picture);
//        mTextureView =  findViewById(R.id.camera_preview);
//        act_button.setOnTouchListener(this);
////        创建文件
////        mFile = new File(getExternalFilesDir(null), "img.jpg");
//
//    }
//
//    @Override
...
//                DataFlow.setScreenSize(maxPreviewHeight,maxPreviewWidth);
...
//            @Override
//            public void run() {
//                Toast.makeText(CameraActivity_OLD.this, text, Toast.LENGTH_SHORT).show();
//            }
//        });
//    }
//
...
//                    act_button.setBackgroundResource(R.drawable.button_2);
//                }
//                if (motionEvent.getAction() == MotionEvent.ACTION_UP) {
//                    act_button.setBackgroundResource(R.drawable.button_1);
//                    LoadingDialog.show(this);
//                    showToast("Proccessing......");
//                    takePicture();
//                    act_button.performClick();
//                }
//                break;
//            }
//        }
...
//        @Override
//        public void run() {
//            System.out.println(mImage.getHeight()+"+"+mImage.getWidth());
//            Intent intent = null;
//            ByteBuffer buffer = mImage.getPlanes()[0].getBuffer();
//            byte[] img = new byte[buffer.remaining()];
//            buffer.get(img);
//////            HashMap<String,String>header=new HashMap();
//////            String APIKey="5d2ec901";
//////            String X_CurTime=String.valueOf(Calendar.getInstance(TimeZone.getTimeZone("UTC")).getTimeInMillis()/1000L);
//////            String X_Param="eyJlbmdpbmVfdHlwZSI6InNtczE2ayIsImF1ZSI6InJhdyJ9";
//////            String X_CheckSum=dataFlow.MD5(APIKey + X_CurTime + X_Param);
//////            header.put("X-Appid",APIKey);
//////            header.put("X-CurTime",X_CurTime);
//////            header.put("X-Param",X_Param);
//////            header.put("X-CheckSum",X_CheckSum);
//////            dataFlow .setHeader(header);
//
//            String json_data = DataFlow.sendData(img);
