	...
	private void init() {
		...
		register.setOnClickListener(new OnClickListener() {
			...
			if(personName==null||personPwd==null||(!personPwd.equals(personPwd2))){
				Toast.makeText(CustomRegisterPage.this,getResources().getString(R.string.account_wrong),Toast.LENGTH_SHORT).show();
				return;
			}
				...
				person.save(CustomRegisterPage.this, new SaveListener() {
					...
					public void onSuccess() {
						...
						Toast.makeText(CustomRegisterPage.this, getResources().getString(R.string.regiest_success),Toast.LENGTH_SHORT).show();
					}
					...
					public void onFailure(int arg0, String arg1) {
						...
						pwd1.setText(null);
						pwd2.setText(null);
						warn.setText(getResources().getString(R.string.account_have_already));
						Toast.makeText(CustomRegisterPage.this, getResources().getString(R.string.regoset_faile),Toast.LENGTH_SHORT).show();
					}
				});
