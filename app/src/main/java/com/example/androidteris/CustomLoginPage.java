	...
	public void onClick(View v) {
		...
		case R.id.login:
			...
			if(Cname==null||Cpasswords==null){
				Toast.makeText(CustomLoginPage.this, getResources().getString(R.string.account_wrong),Toast.LENGTH_SHORT).show();
				break;
			}
			...
			bmobQuery.findObjects(this, new FindListener<PersonDate>() {
				...
				public void onSuccess(List<PersonDate> arg0) {
                       ...
                       if(Cpasswords.equals(arg0.get(0).getPassword())){
						...
						pwd.setText(null);
						Toast.makeText(CustomLoginPage.this, getResources().getString(R.string.password_wrong),Toast.LENGTH_SHORT).show();
					}
				}
			});
