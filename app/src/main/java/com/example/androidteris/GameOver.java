		...
		button2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(Constant.CustomName==null){
					...
					Toast.makeText(GameOver.this, getResources().getString(R.string.plase_login), Toast.LENGTH_SHORT).show();
					...
					player.save(GameOver.this,new SaveListener() {
						...
						public void onSuccess() {
							...
							Toast.makeText(GameOver.this, getResources().getString(R.string.data_upload_success), Toast.LENGTH_SHORT).show();
						}
						
						@Override
						public void onFailure(int arg0, String arg1) {
							
							Toast.makeText(GameOver.this,getResources().getString(R.string.data_upload_faile), Toast.LENGTH_SHORT).show();
						}
					});
