	...
	private void init() {
		...
		players.findObjects(CustomRecord.this, new FindListener<PlayerData>() {
			...
			public void onError(int arg0, String arg1) {
				// TODO Auto-generated method stub
				Toast.makeText(CustomRecord.this, getResources().getString(R.string.get_data_faile), Toast.LENGTH_SHORT).show();
			}
		});
		...
		players2.findObjects(CustomRecord.this, new FindListener<PlayerData>() {
			...
			public void onSuccess(List<PlayerData> arg0) {
				...
				players3.count(getApplicationContext(), PlayerData.class, new CountListener() {
					...
					public void onFailure(int arg0, String arg1) {
						// TODO Auto-generated method stub
						Toast.makeText(CustomRecord.this, getResources().getString(R.string.players3_get_data_faile), Toast.LENGTH_SHORT).show();
					}
			...
			@Override
			public void onError(int arg0, String arg1) {
				Toast.makeText(CustomRecord.this, getResources().getString(R.string.get_data_faile1), Toast.LENGTH_SHORT).show();
		...
		playersRank.findObjects(getApplicationContext(), new FindListener<PlayerData>() {
			...
			public void onError(int arg0, String arg1) {
				// TODO Auto-generated method stub
				Toast.makeText(CustomRecord.this, getResources().getString(R.string.get_data_faile2), Toast.LENGTH_SHORT).show();
			}
		});
