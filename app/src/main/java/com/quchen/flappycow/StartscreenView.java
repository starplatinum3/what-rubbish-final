...
public class StartscreenView extends View{
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(event.getAction() == MotionEvent.ACTION_DOWN) {
            if(    (event.getX() > REGION_LOG_IN_OUT[0] * getWidth())
                ...
                //new Intent("com.quchen.flappycow.Game");
                //String canonicalName = Game.class.getClass().getCanonicalName();
                ////I/canonicalName: onTouchEvent: java.lang.Class
                ////Game.getClass().getClass()
                //Log.i("canonicalName", "onTouchEvent: "+canonicalName);
                //之前因为安装了他原本的程序 所以他去打开那个程序了
                //Game.musicPlayer
                //mainActivity.startActivity(new Intent("com.quchen.flappycow.Game"));
                String packageName = getPackageName(Game.class);
                Log.i("packageName", "onTouchEvent: "+packageName);
                //mainActivity.startActivity(new Intent(String.valueOf(Game.class)));
                mainActivity.startActivity(new Intent(packageName));
                ////mainActivity.startActivity(new Intent(Game.class));
    ...
    String  getPackageName( Class<?> cls){
       //Class<?> cls= Game.class;
        //new Intent(String.valueOf(Game.class)
        String s = String.valueOf(cls);
        String class_ = s.replace("class ", "");
        return class_;
        //new Intent(String.valueOf(cls)
    }
