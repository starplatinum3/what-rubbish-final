    ...
    public void draw(Canvas canvas,Paint paint){
	    if(isVisiable()) {
		    ...
		    if (mBitmap != null) {
                ...
                // 参数三是目标区域(应该在canvas的位置和大小)，参数四是Paint画刷对象，因为用到了缩放和拉伸的可能，
                // 当原始Rect不等于目标Rect时性能将会有大幅损失。
                //https://blog.csdn.net/huaxun66/article/details/52222643
...
//        Log.i("col", "siteCollisionWith: "+col);
//        Log.i("row", "siteCollisionWith: "+row);
        //超出边界
