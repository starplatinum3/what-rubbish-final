...
import com.example.whatrubbish.MyApplication;
...
public class EmojiDao {
    ...
    public static String CopySqliteFileFromRawToDatabases(String SqliteFileName) throws IOException {
        ...
        //File dir = new File("data/data/" + "com.example.smlj" + "/databases");
        File dir = new File("data/data/" + Bus.packageName + "/databases");
        ...
        if (!file.exists()) {
            try {
                ...
                inputStream = MyApplication.mApplication.getClass().getClassLoader().getResourceAsStream("assets/" + SqliteFileName);
                Log.d(TAG, "CopySqliteFileFromRawToDatabases: inputStream  "+inputStream);
