...
//            public Button(float left, float top, float width, float height, int res, Resources resources) {
        ...
        Button button = new Button(R.drawable.button, screen_width, screen_height, resources);
//        button.draw();
//        button.draw();
        scalex = screen_width / background.getWidth();
        scaley = screen_height / background.getHeight();
        button_x = screen_width / 2 - this.button.getWidth() / 2;
        button_y = screen_height / 2 + this.button.getHeight();
        button_y2 = button_y + this.button.getHeight() + 40;
